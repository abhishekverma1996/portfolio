...
const Data = () => {
  ...
  const originalText = "Abhishek Verma";
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Full Stack Mern Developer</h3>
      <p className="home__description">React.js,Node.js,MongoDB,Express.js |7+ Years IT Experience(Support & Development)</p>

      <a href="https://schedule.fillout.com/t/sc2qTXX2gvus" className="button button--flex">
        Say Hello
        <svg
